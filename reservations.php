...
$reservations = array_reverse($reservations->getUserReservations($user_id));
                ...
                <div class="col-12 col-sm-6 col-xl-8">
                    ...
                    <div class="row"> <!-- DISPLAY IF NO RESERVATIONS -->
                        <div class="col pt-3 ms-md-4 ps-md-3">
                            ...
                            <h3 class="apptNum"><?= $reservation_number ?></h3>
                            <h3 class="name"><i class="fa-solid fa-location-dot"></i> <a href="view.php?property_id=<?= $property_id ?>" style="text-decoration: none; color: inherit;"><?= $property_name ?></a> </h3>
                            <h3 class="address"><?= $full_address ?></h3>
                            <h6 class="roomStatus"><?= $unit_type ?></h6>
                        </div>

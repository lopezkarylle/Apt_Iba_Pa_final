...
foreach($properties as $property_item){
    ...
    if($property_item['barangay']==='Lourdes Sur East'){
        ...
        $count_salapungan = $count_salapungan + 1;
    } elseif ($property_item['barangay']==='Claro M. Recto'){
        $count_claro = $count_claro + 1;
    }
...
<section class="hero" id="home">
    ...
    <div class="row my-5 gap-5 gap-md-0">
      <div class="col-12 col-md-6 py-auto my-auto order-5 order-md-0" >
        ...
        <h1 class="hero-title text-center text-md-start fw-bold display-1">Your Second Home Search <span class="text" style="color:hsl(200, 69%, 14%)">Made Easy</span>
        </h1>
...
<!-- Hero -->
          ...
          <div class="row gy-4">
                <div class="col ">
                    <div class="box-container">
                        ...
                        <button type="submit" class="box">
                            <img src="resources/images/count<?php echo $count_lourdes ?>.png" alt="" /> <!-- change number icon -->
                ...
                <div class="col ">
                    <div class="box-container">
                        ...
                        <button type="submit" class="box">
                            <img src="resources/images/count<?php echo $count_salapungan ?>.png" alt="" /> <!-- change number icon -->
                ...
                <div class="col ">
                    <div class="box-container">
                        ...
                        <button type="submit" class="box">
                            <img src="resources/images/count<?php echo $count_claro ?>.png" /><!-- change number icon -->
              ...
              <div class="col ">
                <div class="box-container">
                        <form action="accommodations" method="POST">
                      <button type="submit" class="box">
                        <img src="resources/images/count11.png" alt="" />
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            #center-text {
                ...
                width: 70%; /* Make the text span the full width */
                z-index: 1000;
            }
        }
    </style>
    ...
    for (var i = 0; i < latitude.length; i++) {
        ...
        marker.bindPopup(
          ...
          "<a href='view.php?property_id=" + property_id[i] + "' style='text-decoration: none;'>" +
          "<img src='resources/images/properties/" + displayImage[i] + "' alt='" + propertyNames[i] + "' style='max-width: 150px; height: 150px; border-radius: 5px; border: 3px solid var(--orange-soda);'>" +
          "</a>" +

<?php
    ...
    if(isset($_POST['add_user'])){
        ...
        echo '<script>window.location.href="users.php?success=1"</script>';
        exit();
    } 
    ...
    elseif(isset($_POST['edit_user'])){
        ...
        echo '<script>window.location.href="users.php?success=2"</script>';
        exit();
    }
    ...
    elseif(isset($_POST['delete_user'])){
        ...
        if($user && $auth){
            echo '<script>window.location.href="users.php?success=3"</script>';
            exit();
        } else {
            echo '<script>window.location.href="users.php?error=1"</script>';
            exit();
        }
    }

    else {
        echo "<script>window.location.href='add-user';</script>";
        exit();
    }
?>
	...
	<section id="content">
		...
		<main>
			<div class="head-title">
                ...
                <a href="add-landlord" class="btn-add">
					...
					<table>
						...
						<tbody>
                            <?php
                                ...
                                $landlords = array_reverse($landlords->getLandlords());
                                
                                foreach($landlords as $landlord){
                                    $landlord_image = isset($landlord['image_name']) ? $landlord['image_name'] : 'male-logo.png';
                                    if($landlord['status']===1){
                                        $status = 'Active';
                                    } else if ($landlord['status']===2){
                                        $status = 'Pending';
                                    }
                            ?>
							<tr>
                                <td><img src="../resources/images/landlords/<?php echo $landlord_image ?>"></td>
								<td>
                                    <p>
                                    <?php echo $landlord['user_id']?>
                                    </p>
								</td>
								<td><p><?php echo $landlord['first_name']?></p></td>
								<td><p><?php echo $landlord['last_name']?></p></td>
								<td><p><?php echo $landlord['property_name']?></p></td>
								<td><p><?php echo $landlord['contact_number']?></p></td>
								<td><p><?php echo $landlord['email']?></p></td>
			...
			<div id="edit-form" class="edit-data" >
				<div class="order">
                    ...
                    <form action="edit-landlord" method="POST" id="editForm" enctype="multipart/form-data">
					...
					<div class="row saveNcancel">
						<div class="saveNcancel">
                            ...
                            <button class="edtSaveChanges" type="submit" id="save-btn" name="edit_landlord">Save Changes</button>
                            </form>

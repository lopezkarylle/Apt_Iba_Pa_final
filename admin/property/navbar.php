      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="../landlord/index.php">Manage Landlords</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="../user/index.php">Manage Users</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="index.php">Manage Properties</a>
                    </li>
                </ul>

document.addEventListener("DOMContentLoaded", function() {
    ...
    const ownerSelect = document.getElementById("landlord_id");
    ...
    [totalBedsSelect, furnishedTypeSelect, minWeeksSelect, ownerSelect, fromCurfewSelect, toCurfewSelect, regionSelect, provinceSelect, citySelect, barangaySelect].forEach(select => {

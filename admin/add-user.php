		...
		<main>
			...
			<div id="add-form" class="add-data" >
				<div class="order">
                    ...
                    <form action="edit-user" method="POST" id="addForm" enctype="multipart/form-data">
                            ...
                            <div class="row saveNcancel">
                                <div class="saveNcancel">
                                    ...
                                    <button class="edtSaveChanges" type="submit" id="add-btn" name="add_user">Add User</button>

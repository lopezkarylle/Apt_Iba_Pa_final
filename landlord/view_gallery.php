                ...
                <img class="img-fluid" width="800" height="600" src="../resources/images/properties/<?= $image_path ?>" alt="">
                    <div class="dropdown position-absolute dropAction">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                          <li><a class="dropdown-item btnEditG" href="#" role="button" data-bs-toggle="modal" data-bs-target="#editCarouselImg" data-image-id="<?php echo $image_id ?>" data-image-title="<?php echo $title ?>">Edit</a></li>
...
$(document).ready(function() {
    $('.btnEditG').on('click', function() {
        $('#editCarouselImg').modal('show');
        // var imageId = $(this).data('image-id');
        // var title = $(this).data('image-title');
        // var imagePath = $(this).closest('.img-container').find('img').attr('src');

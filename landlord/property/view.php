...
<form action="edit.php" method="POST">
		...
		<div class="row form-group">
            <div class="col-md-4">
			<?php 
			$availableAmenities = array("wifi","parking","reception","food_hall","lounge","study_area","laundromat","elevator","drinking_water","microwave","refrigerator","tv","roof_deck","sink","security","cctv","fire_exit");

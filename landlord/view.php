<?php
    ...
    $details = $property->getLandlordProperty($property_id, $user_id);
    ...
    $display_reviews = $reviews->getReviews($property_id);
  ...
  <div class="modal-dialog modal-dialog-centered editCarouselImg">
    <div class="modal-content ">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary btnUpdate" data-bs-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-primary btnUpdate" name="update_image">Update</button>
      </div>
      </form>
    </div>
  </div>
...
<div class="modal fade" id="addCarouselImg" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="addCarouselImgLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered addCarouselImg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary btnAddImg" data-bs-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-primary btnAddImg" name="add_image">Add</button>
      </div>
      </form>
    </div>
  </div>

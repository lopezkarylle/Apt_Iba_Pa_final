          ...
          <div class="row">
            ...
            <div class="col-12 col-lg-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
              <div class="icon-box">
                ...
                <div class="">
                  <p class="contactDetails"><span class="strong"> Email: </span> hello.aiptenants@gmail.com</p>
            ...
            <div class="col-12 col-lg-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
              <div class="icon-box">
                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="contactDetails"><span class="strong"> Email: </span>hello.aiplandlords@gmail.com</div>
                  </iv>
        ...
        <div class="row">
            ...
            <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch order-2 order-lg-1 mb-5 pb-5">
                ...
                <div class="content">
                    ...
                    <form class="row g-3 needs-validation mt-5" id="feedbackForm">
                      <div class="col-12">
                        <label for="toDo" class="form-label">What would you like to do?</label>
                        <select id="toDo" class="form-select" onchange="enableWhichPart()" required 
                      ...
                      <div class="col-12">
                          ...
                          <select id="whichPart" class="form-select" onchange="showSections()" required disabled 
                        ...
                        <div class="col-12" id="tenantSection" style="display: none;">
                          ...
                          <select id="whichPageTenant" class="form-select" required 
                        ...
                        <div class="col-12" id="landlordSection" style="display: none;">
                          ...
                          <select id="whichPageLandlord" class="form-select" required
                          oninvalid="this.setCustomValidity('Please select which page.')"
                          oninput="setCustomValidity('')">
                        ...
                        <div class="col-12">
                          ...
                          <textarea class="form-control" id="textAreaInsights" aria-label="With textarea" required
            ...
            <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("images/fback.png");' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
        </div>

...
$image_name = $user['image_name'] ?? 'male-logo.png';
?>
            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <img class="img-account-profile rounded-circle mb-2" id="profileImage" src="../resources/images/landlords/<?= $image_name ?>" alt="">
                        <!-- Profile picture help block-->
                        <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                        <!-- Profile picture upload button-->
                        <input type="file" id="imageInput" name="image" style="display: none;" accept="image/*">
                        <button class="btn btn-primary disabled-button" type="button"
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <!-- Save changes button-->
                            <button class="btn btn-primary" id="editProfileButton" type="button" name="edit_profile" onclick="enableInputs()">Edit Profile</button>
                            <a href=""><button class="btn btn-danger" id="editBackButton" type="button">Back</button></a> 
                    </div>
                </div>
            </div>
        </div>
...
try {
     if(isset($_POST['first_name'])){
        ...
        $updated_image_name = $_FILE['image'];

        var_dump($updated_first_name, $updated_last_name, $updated_contact_number, $updated_email, $updated_password, $updated_image_name);

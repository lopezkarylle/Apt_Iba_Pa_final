<?php 
    ...
    if(isset($_GET['chat_id'])){
        try {
            ...
            $chat = $chat->getLandlordChat($user_id, $chat_id);
            ...
            ?>
                ...
                <div class="col-9 mt-3">
                    ...
                    <p class="chatName" ><?php echo $guest_name ?></p>
                </div>
                ...
                <div class="offcanvas-body">
                    ...
                    <div class="card-body p-4" style="height: 850px; overflow: auto; display: flex; flex-direction: column-reverse;">
                        ...
                        foreach($all_messages as $message) { 
                            ...
                            $tenant_picture = $user['image_name'];
                        ...
                        ?>
                            ...
                            <div class="d-flex align-items-baseline mb-4">
                                <div class="position-relative avatar">
                                    <img src="../resources/images/users/<?php echo $tenant_picture ?>" class="img-fluid rounded-circle" alt="">
                                </div>
                                <div class="pe-2">
                                    <div>
                            ...
                            $landlord = $landlord->getById($sender_id);
                            $landlord_picture = $landlord['image_name'];
                            ?>
                            <div class="d-flex align-items-baseline text-end justify-content-end mb-4">
                                ...
                                <div class="position-relative avatar">
                                    <img src="../resources/images/landlords/<?php echo $landlord_picture ?>"
